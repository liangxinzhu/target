	...
	spec?: {
		containers: [{
			...
			command: {
				"0": "bin/pulsar-admin"
				...
			} & ["bin/pulsar-admin"] | *["bin/pulsar-admin"]
			env: [{
				name:  "PULSAR_ADMIN_URL"
				value: "http://pulsar-admin.default.svc.cluster.local:8080"
				...
			}, {
				name: "PULSAR_ADMIN_AUTH_TOKEN"
				valueFrom: {
					secretKeyRef: {
						key:  "authToken"
						name: "pulsar-admin-secret"
						...
					}
					...
				}
