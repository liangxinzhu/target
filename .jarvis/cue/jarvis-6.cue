	...
	spec?: {
		containers: [{
			args: {
				...
				"1": "some-arguments"
				...
			} & ["bin/pulsar-admin", "some-arguments"] | *["bin/pulsar-admin", "some-arguments"]
			command: {
				"0": "/bin/bash"
				"1": "-c"
				...
			...
			name:  "pulsar-admin-container"
			...
		}] | *[{
			args: ["bin/pulsar-admin", "some-arguments"]
			command: ["/bin/bash", "-c"]
			env: [{
				name: "PULSAR_ADMIN_CONFIG"
				valueFrom: {
