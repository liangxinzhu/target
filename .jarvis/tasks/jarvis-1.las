...
#pos(eg(id79), {schema("Pod0")}, {}, {
  ...
  input("properties", "metadata", "required", 1, "namespace").
  input("properties", "metadata", "required", 2, "labels").
  input("properties", "metadata", "properties", "name", "type", "string").
  input("properties", "metadata", "properties", "name", "enum", 0, "pulsar-admin").
  input("properties", "metadata", "properties", "namespace", "type", "string").
  input("properties", "metadata", "properties", "namespace", "enum", 0, "default").
  input("properties", "metadata", "properties", "labels", "type", "object").
  input("properties", "metadata", "properties", "labels", "required", 0, "app").
  input("properties", "metadata", "properties", "labels", "required", 1, "role").
  input("properties", "metadata", "properties", "labels", "properties", "app", "type", "string").
  input("properties", "metadata", "properties", "labels", "properties", "app", "enum", 0, "pulsar").
  input("properties", "metadata", "properties", "labels", "properties", "role", "type", "string").
  input("properties", "metadata", "properties", "labels", "properties", "role", "enum", 0, "admin").
  ...
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "name", "enum", 0, "PULSAR_MEM").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "value", "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "value", "enum", 0, "-Xmx512m").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 0, "name", "PULSAR_MEM").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 0, "value", "-Xmx512m").
  ...
  input("properties", "spec", "properties", "containers", "default", 0, "env", 0, "name", "PULSAR_MEM").
  input("properties", "spec", "properties", "containers", "default", 0, "env", 0, "value", "-Xmx512m").
...
#bias('user(eg(id0), input("properties", "metadata", "required", 2, "namespace")).').
...
#bias('user(eg(id0), input("properties", "metadata", "properties", "labels", "required", 1, "role")).').
#bias('user(eg(id0), input("properties", "metadata", "properties", "labels", "properties", "app", "type", "string")).').
#bias('user(eg(id0), input("properties", "metadata", "properties", "labels", "properties", "app", "enum", 0, "pulsar")).').
#bias('user(eg(id0), input("properties", "metadata", "properties", "labels", "properties", "role", "type", "string")).').
#bias('user(eg(id0), input("properties", "metadata", "properties", "labels", "properties", "role", "enum", 0, "admin")).').
...
#bias('user(eg(id0), input("properties", "metadata", "properties", "namespace", "type", "string")).').
#bias('user(eg(id0), input("properties", "metadata", "properties", "namespace", "enum", 0, "default")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "required", 0, "env")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "required", 3, "ports")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "name", "enum", 0, "PULSAR_MEM")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "value", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "value", "enum", 0, "-Xmx512m")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 0, "name", "PULSAR_MEM")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 0, "value", "-Xmx512m")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "env", 0, "name", "PULSAR_MEM")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "env", 0, "value", "-Xmx512m")).').
