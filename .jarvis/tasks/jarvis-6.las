...
#pos(eg(id16), {schema("Service0")}, {}, {
  ...
  input("properties", "metadata", "properties", "name", "enum", 0, "open-api-doc").
  ...
  input("properties", "metadata", "properties", "labels", "properties", "app", "enum", 0, "open-api-doc").
  input("properties", "spec", "type", "object").
  input("properties", "spec", "required", 0, "type").
  input("properties", "spec", "required", 1, "selector").
  input("properties", "spec", "required", 2, "ports").
  ...
  input("properties", "spec", "properties", "selector", "properties", "app", "enum", 0, "open-api-doc").
  ...
  input("properties", "spec", "properties", "ports", "items", 0, "properties", "targetPort", "enum", 0, "int(\"80\")").
  ...
  input("properties", "spec", "properties", "ports", "default", 0, "targetPort", "int(\"80\")").
...
schema15("ServiceExternalTrafficPolicy").

#modeh(schema(const(schema16))).
schema16("ManagedFieldsEntry").

#modeh(schema(const(schema17))).
schema17("ServicePort").

#modeh(schema(const(schema18))).
schema18("ConditionStatus").

#modeh(schema(const(schema19))).
schema19("IntOrString").

#modeh(schema(const(schema20))).
schema20("ServiceStatus").

#modeh(schema(const(schema21))).
schema21("ServiceType").

#modeh(schema(const(schema22))).
schema22("LoadBalancerIngress").
...
#bias('user(eg(id0), input("properties", "metadata", "properties", "labels", "properties", "app", "enum", 0, "open-api-doc")).').
#bias('user(eg(id0), input("properties", "metadata", "properties", "name", "type", "string")).').
#bias('user(eg(id0), input("properties", "metadata", "properties", "name", "enum", 0, "open-api-doc")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "ports", "items", 0, "properties", "port", "enum", 0, "int(\"80\")")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "ports", "items", 0, "properties", "targetPort", "enum", 0, "int(\"80\")")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "ports", "default", 0, "targetPort", "int(\"80\")")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "selector", "properties", "app", "enum", 0, "open-api-doc")).').
