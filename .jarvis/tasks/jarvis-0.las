...
#pos(eg(id16), {schema("Service0")}, {}, {
  ...
  input("properties", "metadata", "properties", "name", "enum", 0, "kubernetes-service").
...
schema14("ServiceType").

#modeh(schema(const(schema15))).
schema15("SessionAffinityConfig").

#modeh(schema(const(schema16))).
schema16("ServiceSpec").

#modeh(schema(const(schema17))).
schema17("ManagedFieldsEntry").
...
#bias('user(eg(id0), input("properties", "metadata", "properties", "name", "enum", 0, "kubernetes-service")).').
