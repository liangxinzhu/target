...
#pos(eg(id16), {schema("Service0")}, {}, {
  ...
  input("properties", "metadata", "properties", "name", "enum", 0, "service").
  ...
  input("properties", "metadata", "properties", "labels", "properties", "app", "enum", 0, "myapp").
  ...
  input("properties", "spec", "properties", "ports", "items", 0, "properties", "targetPort", "enum", 0, "int(\"9376\")").
  ...
  input("properties", "spec", "properties", "ports", "default", 0, "targetPort", "int(\"9376\")").
...
schema2("ServiceExternalTrafficPolicy").

#modeh(schema(const(schema3))).
schema3("Protocol").

#modeh(schema(const(schema4))).
schema4("ClientIPConfig").
...
schema12("IntOrString").

#modeh(schema(const(schema13))).
schema13("LoadBalancerIngress").
...
#bias('user(eg(id0), input("properties", "metadata", "properties", "labels", "properties", "app", "enum", 0, "myapp")).').
#bias('user(eg(id0), input("properties", "metadata", "properties", "name", "type", "string")).').
#bias('user(eg(id0), input("properties", "metadata", "properties", "name", "enum", 0, "service")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "ports", "items", 0, "properties", "targetPort", "enum", 0, "int(\"9376\")")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "ports", "default", 0, "targetPort", "int(\"9376\")")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "selector", "properties", "app", "enum", 0, "myapp")).').
