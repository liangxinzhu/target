...
schema14("ServiceAffinity").

#modeh(schema(const(schema15))).
schema15("ServiceSpec").

#modeh(schema(const(schema16))).
schema16("ServiceType").

#modeh(schema(const(schema17))).
schema17("ManagedFieldsOperationType").

#modeh(schema(const(schema18))).
schema18("ServiceExternalTrafficPolicy").
