...
schema0("SessionAffinityConfig").

#modeh(schema(const(schema1))).
schema1("ServiceExternalTrafficPolicy").
...
schema11("LoadBalancerStatus").

#modeh(schema(const(schema12))).
schema12("OwnerReference").
...
schema26("ManagedFieldsOperationType").
