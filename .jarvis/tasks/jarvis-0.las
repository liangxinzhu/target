...
#pos(eg(id25), {schema("Deployment0")}, {}, {
  input("description", "Define Deployment").
  input("type", "object").
  ...
  input("properties", "metadata", "properties", "name", "enum", 0, "simple-app-deployment").
  ...
  input("properties", "spec", "properties", "replicas", "enum", 0, "int(\"1\")").
  ...
  input("properties", "spec", "properties", "selector", "properties", "matchLabels", "properties", "app", "enum", 0, "SimpleApp").
  ...
  input("properties", "spec", "properties", "template", "properties", "metadata", "properties", "labels", "properties", "app", "enum", 0, "SimpleApp").
  ...
  input("properties", "spec", "properties", "template", "properties", "spec", "properties", "containers", "items", 0, "properties", "name", "enum", 0, "simple-app-container").
  input("properties", "spec", "properties", "template", "properties", "spec", "properties", "containers", "items", 0, "properties", "image", "type", "string").
  input("properties", "spec", "properties", "template", "properties", "spec", "properties", "containers", "items", 0, "properties", "image", "enum", 0, "nginx:1.14.2").
  ...
  input("properties", "spec", "properties", "template", "properties", "spec", "properties", "containers", "default", 0, "name", "simple-app-container").
  input("properties", "spec", "properties", "template", "properties", "spec", "properties", "containers", "default", 0, "image", "nginx:1.14.2").
...
#pos(eg(id57), {schema("Instance")}, {}, {
  input("description", "Define the Instance").
  input("type", "object").
  input("required", 0, "objects").
  input("properties", "objects", "type", "array").
  input("properties", "objects", "items", 0, "$ref", "#/components/schemas/Service0").
  input("properties", "objects", "items", 1, "$ref", "#/components/schemas/Deployment0").
  input("properties", "objects", "default", 0, "metadata", "name", "simple-app-service").
  input("properties", "objects", "default", 0, "spec", "ports", 0, "protocol", "TCP").
  input("properties", "objects", "default", 0, "spec", "ports", 0, "port", "int(\"80\")").
  input("properties", "objects", "default", 0, "spec", "ports", 0, "targetPort", "int(\"8080\")").
  input("properties", "objects", "default", 0, "spec", "selector", "app", "SimpleApp").
  input("properties", "objects", "default", 0, "kind", "Service").
  input("properties", "objects", "default", 0, "apiVersion", "v1").
  input("properties", "objects", "default", 1, "metadata", "name", "simple-app-deployment").
  input("properties", "objects", "default", 1, "spec", "replicas", "int(\"1\")").
  input("properties", "objects", "default", 1, "spec", "selector", "matchLabels", "app", "SimpleApp").
  input("properties", "objects", "default", 1, "spec", "template", "metadata", "labels", "app", "SimpleApp").
  input("properties", "objects", "default", 1, "spec", "template", "spec", "containers", 0, "name", "simple-app-container").
  input("properties", "objects", "default", 1, "spec", "template", "spec", "containers", 0, "image", "nginx:1.14.2").
  input("properties", "objects", "default", 1, "spec", "template", "spec", "containers", 0, "ports", 0, "containerPort", "int(\"8080\")").
  input("properties", "objects", "default", 1, "kind", "Deployment").
  input("properties", "objects", "default", 1, "apiVersion", "apps/v1").
}).
...
#pos(eg(id127), {schema("Service0")}, {}, {
  input("description", "Define Service").
  input("type", "object").
  input("properties", "apiVersion", "type", "string").
  ...
  input("properties", "metadata", "required", 0, "name").
  input("properties", "metadata", "properties", "name", "type", "string").
  input("properties", "metadata", "properties", "name", "enum", 0, "simple-app-service").
  input("properties", "spec", "type", "object").
  ...
  input("properties", "spec", "properties", "selector", "properties", "app", "enum", 0, "SimpleApp").
...
input8("default").
input10("name").
input11("simple-app-container").
input10("image").
input11("nginx:1.14.2").
input10("ports").
...
input8(0).
input9("name").
input10("simple-app-container").
input9("image").
input10("nginx:1.14.2").
input9("ports").
input10(0).
...
schema70("PersistentVolumeClaimSpec").

#modeh(schema(const(schema71))).
schema71("EphemeralContainerCommon").

#modeh(schema(const(schema72))).
schema72("PhotonPersistentDiskVolumeSource").

#modeh(schema(const(schema73))).
schema73("ServiceStatus").

#modeh(schema(const(schema74))).
schema74("Service0").

#modeh(schema(const(schema75))).
schema75("LabelSelectorOperator").

#modeh(schema(const(schema76))).
schema76("CSIVolumeSource").

#modeh(schema(const(schema77))).
schema77("LoadBalancerIngress").

#modeh(schema(const(schema78))).
schema78("NodeAffinity").

#modeh(schema(const(schema79))).
schema79("RBDVolumeSource").

#modeh(schema(const(schema80))).
schema80("FCVolumeSource").

#modeh(schema(const(schema81))).
schema81("WeightedPodAffinityTerm").

#modeh(schema(const(schema82))).
schema82("DeploymentConditionType").

#modeh(schema(const(schema83))).
schema83("StorageOSVolumeSource").

#modeh(schema(const(schema84))).
schema84("DeploymentStatus").

#modeh(schema(const(schema85))).
schema85("SeccompProfileType").

#modeh(schema(const(schema86))).
schema86("ExecAction").

#modeh(schema(const(schema87))).
schema87("ManagedFieldsEntry").

#modeh(schema(const(schema88))).
schema88("PersistentVolumeClaimVolumeSource").
...
#bias('user(eg(id0), input("properties", "metadata", "properties", "name", "enum", 0, "simple-app-deployment")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "replicas", "enum", 0, "int(\"1\")")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "selector", "properties", "matchLabels", "properties", "app", "enum", 0, "SimpleApp")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "template", "properties", "metadata", "properties", "labels", "properties", "app", "enum", 0, "SimpleApp")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "template", "properties", "spec", "properties", "containers", "items", 0, "properties", "image", "enum", 0, "nginx:1.14.2")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "template", "properties", "spec", "properties", "containers", "items", 0, "properties", "name", "enum", 0, "simple-app-container")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "template", "properties", "spec", "properties", "containers", "default", 0, "image", "nginx:1.14.2")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "template", "properties", "spec", "properties", "containers", "default", 0, "name", "simple-app-container")).').
...
#bias('user(eg(id1), input("properties", "metadata", "properties", "name", "enum", 0, "simple-app-service")).').
...
#bias('user(eg(id1), input("properties", "spec", "properties", "selector", "properties", "app", "enum", 0, "SimpleApp")).').
