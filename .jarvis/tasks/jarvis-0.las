...
#pos(eg(id79), {schema("Pod0")}, {}, {
  ...
  input("properties", "spec", "properties", "containers", "items", 0, "required", 3, "resources").
  ...
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "required", 0, "cpu").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "required", 1, "memory").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "properties", "cpu", "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "properties", "cpu", "enum", 0, "100m").
  ...
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "properties", "memory", "enum", 0, "200Mi").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "type", "object").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "required", 0, "cpu").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "required", 1, "memory").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "properties", "cpu", "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "properties", "cpu", "enum", 0, "500m").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "properties", "memory", "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "properties", "memory", "enum", 0, "500Mi").
  ...
  input("properties", "spec", "properties", "containers", "default", 0, "resources", "requests", "cpu", "100m").
  input("properties", "spec", "properties", "containers", "default", 0, "resources", "requests", "memory", "200Mi").
  input("properties", "spec", "properties", "containers", "default", 0, "resources", "limits", "cpu", "500m").
  input("properties", "spec", "properties", "containers", "default", 0, "resources", "limits", "memory", "500Mi").
...
schema0("RBDVolumeSource").

#modeh(schema(const(schema1))).
schema1("GitRepoVolumeSource").

#modeh(schema(const(schema2))).
schema2("EphemeralVolumeSource").

#modeh(schema(const(schema3))).
schema3("PodAffinityTerm").
...
schema37("ContainerStateWaiting").

#modeh(schema(const(schema38))).
schema38("VolumeProjection").

#modeh(schema(const(schema39))).
schema39("PersistentVolumeAccessMode").
...
schema45("NFSVolumeSource").

#modeh(schema(const(schema46))).
schema46("SecurityContext").

#modeh(schema(const(schema47))).
schema47("PodDNSConfig").

#modeh(schema(const(schema48))).
schema48("SeccompProfileType").

#modeh(schema(const(schema49))).
schema49("LifecycleHandler").

#modeh(schema(const(schema50))).
schema50("HostPathVolumeSource").

#modeh(schema(const(schema51))).
schema51("LabelSelectorOperator").

#modeh(schema(const(schema52))).
schema52("VolumeSource").
...
schema55("NodeSelectorRequirement").
...
schema60("EnvFromSource").

#modeh(schema(const(schema61))).
schema61("KeyToPath").

#modeh(schema(const(schema62))).
schema62("DownwardAPIProjection").

#modeh(schema(const(schema63))).
schema63("PersistentVolumeClaimVolumeSource").

#modeh(schema(const(schema64))).
schema64("AWSElasticBlockStoreVolumeSource").
...
schema67("LabelSelectorRequirement").

#modeh(schema(const(schema68))).
schema68("EphemeralContainer").

#modeh(schema(const(schema69))).
schema69("ContainerStateRunning").

#modeh(schema(const(schema70))).
schema70("ContainerResizePolicy").

#modeh(schema(const(schema71))).
schema71("ResourceResizeRestartPolicy").

#modeh(schema(const(schema72))).
schema72("SecretVolumeSource").

#modeh(schema(const(schema73))).
schema73("TypedLocalObjectReference").

#modeh(schema(const(schema74))).
schema74("SleepAction").

#modeh(schema(const(schema75))).
schema75("Capabilities").

#modeh(schema(const(schema76))).
schema76("DownwardAPIVolumeFile").

#modeh(schema(const(schema77))).
schema77("AzureDiskVolumeSource").

#modeh(schema(const(schema78))).
schema78("EphemeralContainerCommon").

#modeh(schema(const(schema79))).
schema79("TypedObjectReference").

#modeh(schema(const(schema80))).
schema80("VolumeMount").

#modeh(schema(const(schema81))).
schema81("SeccompProfile").

#modeh(schema(const(schema82))).
schema82("ISCSIVolumeSource").

#modeh(schema(const(schema83))).
schema83("ResourceFieldSelector").

#modeh(schema(const(schema84))).
schema84("OSName").

#modeh(schema(const(schema85))).
schema85("LabelSelector").

#modeh(schema(const(schema86))).
schema86("PodConditionType").

#modeh(schema(const(schema87))).
schema87("ContainerState").

#modeh(schema(const(schema88))).
schema88("OwnerReference").

#modeh(schema(const(schema89))).
schema89("PersistentVolumeClaimSpec").

#modeh(schema(const(schema90))).
schema90("ConfigMapEnvSource").
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "required", 3, "resources")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "required", 0, "cpu")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "required", 1, "memory")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "properties", "cpu", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "properties", "cpu", "enum", 0, "500m")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "properties", "memory", "enum", 0, "500Mi")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "required", 0, "cpu")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "required", 1, "memory")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "properties", "cpu", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "properties", "cpu", "enum", 0, "100m")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "properties", "memory", "enum", 0, "200Mi")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "resources", "limits", "cpu", "500m")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "resources", "limits", "memory", "500Mi")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "resources", "requests", "cpu", "100m")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "resources", "requests", "memory", "200Mi")).').
