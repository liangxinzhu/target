...
#pos(eg(id79), {schema("Pod0")}, {}, {
  ...
  input("properties", "spec", "required", 1, "initContainers").
  input("properties", "spec", "required", 2, "volumes").
  ...
  input("properties", "spec", "properties", "containers", "items", 0, "required", 2, "command").
  input("properties", "spec", "properties", "containers", "items", 0, "required", 3, "env").
  input("properties", "spec", "properties", "containers", "items", 0, "required", 4, "resources").
  ...
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "type", "array").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "items", 0, "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "items", 0, "enum", 0, "/bin/sh").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "items", 1, "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "items", 1, "enum", 0, "-c").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "items", 2, "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "items", 2, "enum", 0, "/pulsar/bin/pulsar-admin ${webServiceUrl} --admin-url ${brokerServiceUrl}").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "enum", 0, 0, "/bin/sh").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "enum", 0, 1, "-c").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "enum", 0, 2, "/pulsar/bin/pulsar-admin ${webServiceUrl} --admin-url ${brokerServiceUrl}").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "default", 0, "/bin/sh").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "default", 1, "-c").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "default", 2, "/pulsar/bin/pulsar-admin ${webServiceUrl} --admin-url ${brokerServiceUrl}").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "type", "array").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "type", "object").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "required", 0, "name").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "required", 1, "valueFrom").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "name", "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "name", "enum", 0, "webServiceUrl").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "type", "object").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "required", 0, "configMapKeyRef").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "type", "object").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "required", 0, "name").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "required", 1, "key").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "name", "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "name", "enum", 0, "pulsar-admin-config").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "key", "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "key", "enum", 0, "WEB_SERVICE_URL").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "type", "object").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "required", 0, "name").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "required", 1, "valueFrom").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "name", "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "name", "enum", 0, "brokerServiceUrl").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "type", "object").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "required", 0, "configMapKeyRef").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "type", "object").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "required", 0, "name").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "required", 1, "key").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "name", "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "name", "enum", 0, "pulsar-admin-config").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "key", "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "key", "enum", 0, "BROKER_SERVICE_URL").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 0, "name", "webServiceUrl").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 0, "valueFrom", "configMapKeyRef", "name", "pulsar-admin-config").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 0, "valueFrom", "configMapKeyRef", "key", "WEB_SERVICE_URL").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 1, "name", "brokerServiceUrl").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 1, "valueFrom", "configMapKeyRef", "name", "pulsar-admin-config").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 1, "valueFrom", "configMapKeyRef", "key", "BROKER_SERVICE_URL").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "type", "object").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "required", 0, "requests").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "required", 1, "limits").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "type", "object").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "required", 0, "memory").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "properties", "memory", "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "properties", "memory", "enum", 0, "512Mi").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "type", "object").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "required", 0, "memory").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "properties", "memory", "type", "string").
  input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "properties", "memory", "enum", 0, "1Gi").
  ...
  input("properties", "spec", "properties", "containers", "default", 0, "command", 0, "/bin/sh").
  input("properties", "spec", "properties", "containers", "default", 0, "command", 1, "-c").
  input("properties", "spec", "properties", "containers", "default", 0, "command", 2, "/pulsar/bin/pulsar-admin ${webServiceUrl} --admin-url ${brokerServiceUrl}").
  input("properties", "spec", "properties", "containers", "default", 0, "env", 0, "name", "webServiceUrl").
  input("properties", "spec", "properties", "containers", "default", 0, "env", 0, "valueFrom", "configMapKeyRef", "name", "pulsar-admin-config").
  input("properties", "spec", "properties", "containers", "default", 0, "env", 0, "valueFrom", "configMapKeyRef", "key", "WEB_SERVICE_URL").
  input("properties", "spec", "properties", "containers", "default", 0, "env", 1, "name", "brokerServiceUrl").
  input("properties", "spec", "properties", "containers", "default", 0, "env", 1, "valueFrom", "configMapKeyRef", "name", "pulsar-admin-config").
  input("properties", "spec", "properties", "containers", "default", 0, "env", 1, "valueFrom", "configMapKeyRef", "key", "BROKER_SERVICE_URL").
  input("properties", "spec", "properties", "containers", "default", 0, "resources", "requests", "memory", "512Mi").
  input("properties", "spec", "properties", "containers", "default", 0, "resources", "limits", "memory", "1Gi").
  input("properties", "spec", "properties", "initContainers", "type", "array").
  input("properties", "spec", "properties", "initContainers", "items", 0, "type", "object").
  input("properties", "spec", "properties", "initContainers", "items", 0, "required", 0, "name").
  input("properties", "spec", "properties", "initContainers", "items", 0, "required", 1, "image").
  input("properties", "spec", "properties", "initContainers", "items", 0, "required", 2, "command").
  input("properties", "spec", "properties", "initContainers", "items", 0, "required", 3, "volumeMounts").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "name", "type", "string").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "name", "enum", 0, "init-config").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "image", "type", "string").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "image", "enum", 0, "alpine").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "type", "array").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "items", 0, "type", "string").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "items", 0, "enum", 0, "/bin/sh").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "items", 1, "type", "string").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "items", 1, "enum", 0, "-c").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "items", 2, "type", "string").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "items", 2, "enum", 0, "source /pulsar/conf/envfile").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "enum", 0, 0, "/bin/sh").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "enum", 0, 1, "-c").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "enum", 0, 2, "source /pulsar/conf/envfile").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "default", 0, "/bin/sh").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "default", 1, "-c").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "default", 2, "source /pulsar/conf/envfile").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "type", "array").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "type", "object").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "required", 0, "name").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "required", 1, "mountPath").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "properties", "name", "type", "string").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "properties", "name", "enum", 0, "config-volume").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "properties", "mountPath", "type", "string").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "properties", "mountPath", "enum", 0, "/pulsar/conf").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "default", 0, "name", "config-volume").
  input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "default", 0, "mountPath", "/pulsar/conf").
  input("properties", "spec", "properties", "initContainers", "default", 0, "name", "init-config").
  input("properties", "spec", "properties", "initContainers", "default", 0, "image", "alpine").
  input("properties", "spec", "properties", "initContainers", "default", 0, "command", 0, "/bin/sh").
  input("properties", "spec", "properties", "initContainers", "default", 0, "command", 1, "-c").
  input("properties", "spec", "properties", "initContainers", "default", 0, "command", 2, "source /pulsar/conf/envfile").
  input("properties", "spec", "properties", "initContainers", "default", 0, "volumeMounts", 0, "name", "config-volume").
  input("properties", "spec", "properties", "initContainers", "default", 0, "volumeMounts", 0, "mountPath", "/pulsar/conf").
  input("properties", "spec", "properties", "volumes", "type", "array").
  input("properties", "spec", "properties", "volumes", "items", 0, "type", "object").
  input("properties", "spec", "properties", "volumes", "items", 0, "required", 0, "name").
  input("properties", "spec", "properties", "volumes", "items", 0, "required", 1, "configMap").
  input("properties", "spec", "properties", "volumes", "items", 0, "properties", "name", "type", "string").
  input("properties", "spec", "properties", "volumes", "items", 0, "properties", "name", "enum", 0, "config-volume").
  input("properties", "spec", "properties", "volumes", "items", 0, "properties", "configMap", "type", "object").
  input("properties", "spec", "properties", "volumes", "items", 0, "properties", "configMap", "required", 0, "name").
  input("properties", "spec", "properties", "volumes", "items", 0, "properties", "configMap", "properties", "name", "type", "string").
  input("properties", "spec", "properties", "volumes", "items", 0, "properties", "configMap", "properties", "name", "enum", 0, "pulsar-admin-config").
  input("properties", "spec", "properties", "volumes", "default", 0, "name", "config-volume").
  input("properties", "spec", "properties", "volumes", "default", 0, "configMap", "name", "pulsar-admin-config").
...
input12("-c").
input9(2).
input12("/pulsar/bin/pulsar-admin ${webServiceUrl} --admin-url ${brokerServiceUrl}").
input10(0).
input11("/bin/sh").
input10(1).
input11("-c").
input10(2).
input11("/pulsar/bin/pulsar-admin ${webServiceUrl} --admin-url ${brokerServiceUrl}").
input8("default").
input10("/bin/sh").
input10("-c").
input10("/pulsar/bin/pulsar-admin ${webServiceUrl} --admin-url ${brokerServiceUrl}").
input7("env").
input11("object").
input10("required").
input12("name").
...
input13("object").
input12("required").
input14("configMapKeyRef").
input12("properties").
input13("configMapKeyRef").
input14("type").
input15("object").
...
input15("key").
input18("WEB_SERVICE_URL").
input14("brokerServiceUrl").
input18("BROKER_SERVICE_URL").
input10("name").
input11("webServiceUrl").
input10("valueFrom").
input11("configMapKeyRef").
input13("pulsar-admin-config").
input12("key").
input13("WEB_SERVICE_URL").
input11("brokerServiceUrl").
input13("BROKER_SERVICE_URL").
input7("resources").
input9("object").
input8("required").
input10("requests").
...
input8("/bin/sh").
input8("-c").
input8("/pulsar/bin/pulsar-admin ${webServiceUrl} --admin-url ${brokerServiceUrl}").
input6("env").
input9("webServiceUrl").
input8("valueFrom").
input9("configMapKeyRef").
input11("pulsar-admin-config").
input10("key").
input11("WEB_SERVICE_URL").
input9("brokerServiceUrl").
input11("BROKER_SERVICE_URL").
input6("resources").
input7("requests").
input8("memory").
input9("512Mi").
input7("limits").
input9("1Gi").
input3("initContainers").
input8("volumeMounts").
input10("init-config").
input10("alpine").
input12("source /pulsar/conf/envfile").
input11("source /pulsar/conf/envfile").
input10("source /pulsar/conf/envfile").
input7("volumeMounts").
input12("mountPath").
input14("config-volume").
input11("mountPath").
input14("/pulsar/conf").
input11("config-volume").
input10("mountPath").
input11("/pulsar/conf").
input7("init-config").
input7("alpine").
input8("source /pulsar/conf/envfile").
input6("volumeMounts").
input9("config-volume").
input8("mountPath").
input9("/pulsar/conf").
input3("volumes").
input8("configMap").
input10("config-volume").
input7("configMap").
input9("name").
input12("pulsar-admin-config").
input7("config-volume").
input6("configMap").
input8("pulsar-admin-config").
...
#bias('user(eg(id0), input("properties", "spec", "required", 1, "initContainers")).').
#bias('user(eg(id0), input("properties", "spec", "required", 2, "volumes")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "required", 0, "command")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "required", 1, "env")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "required", 2, "image")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "required", 3, "name")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "required", 4, "resources")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "type", "array")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "items", 0, "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "items", 0, "enum", 0, "/bin/sh")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "items", 1, "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "items", 1, "enum", 0, "-c")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "items", 2, "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "items", 2, "enum", 0, "/pulsar/bin/pulsar-admin ${webServiceUrl} --admin-url ${brokerServiceUrl}")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "enum", 0, 0, "/bin/sh")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "enum", 0, 1, "-c")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "enum", 0, 2, "/pulsar/bin/pulsar-admin ${webServiceUrl} --admin-url ${brokerServiceUrl}")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "default", 0, "/bin/sh")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "default", 1, "-c")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "command", "default", 2, "/pulsar/bin/pulsar-admin ${webServiceUrl} --admin-url ${brokerServiceUrl}")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "type", "array")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "required", 0, "name")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "required", 1, "valueFrom")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "name", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "name", "enum", 0, "webServiceUrl")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "required", 0, "configMapKeyRef")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "required", 0, "key")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "required", 1, "name")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "key", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "key", "enum", 0, "WEB_SERVICE_URL")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "name", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 0, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "name", "enum", 0, "pulsar-admin-config")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "required", 0, "name")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "required", 1, "valueFrom")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "name", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "name", "enum", 0, "brokerServiceUrl")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "required", 0, "configMapKeyRef")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "required", 0, "key")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "required", 1, "name")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "key", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "key", "enum", 0, "BROKER_SERVICE_URL")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "name", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "items", 1, "properties", "valueFrom", "properties", "configMapKeyRef", "properties", "name", "enum", 0, "pulsar-admin-config")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 0, "name", "webServiceUrl")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 0, "valueFrom", "configMapKeyRef", "key", "WEB_SERVICE_URL")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 0, "valueFrom", "configMapKeyRef", "name", "pulsar-admin-config")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 1, "name", "brokerServiceUrl")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 1, "valueFrom", "configMapKeyRef", "key", "BROKER_SERVICE_URL")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "env", "default", 1, "valueFrom", "configMapKeyRef", "name", "pulsar-admin-config")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "required", 0, "limits")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "required", 1, "requests")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "required", 0, "memory")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "properties", "memory", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "limits", "properties", "memory", "enum", 0, "1Gi")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "required", 0, "memory")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "properties", "memory", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "items", 0, "properties", "resources", "properties", "requests", "properties", "memory", "enum", 0, "512Mi")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "command", 0, "/bin/sh")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "command", 1, "-c")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "command", 2, "/pulsar/bin/pulsar-admin ${webServiceUrl} --admin-url ${brokerServiceUrl}")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "env", 0, "name", "webServiceUrl")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "env", 0, "valueFrom", "configMapKeyRef", "key", "WEB_SERVICE_URL")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "env", 0, "valueFrom", "configMapKeyRef", "name", "pulsar-admin-config")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "env", 1, "name", "brokerServiceUrl")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "env", 1, "valueFrom", "configMapKeyRef", "key", "BROKER_SERVICE_URL")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "env", 1, "valueFrom", "configMapKeyRef", "name", "pulsar-admin-config")).').
...
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "resources", "limits", "memory", "1Gi")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "containers", "default", 0, "resources", "requests", "memory", "512Mi")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "type", "array")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "required", 0, "command")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "required", 1, "image")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "required", 2, "name")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "required", 3, "volumeMounts")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "type", "array")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "items", 0, "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "items", 0, "enum", 0, "/bin/sh")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "items", 1, "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "items", 1, "enum", 0, "-c")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "items", 2, "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "items", 2, "enum", 0, "source /pulsar/conf/envfile")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "enum", 0, 0, "/bin/sh")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "enum", 0, 1, "-c")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "enum", 0, 2, "source /pulsar/conf/envfile")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "default", 0, "/bin/sh")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "default", 1, "-c")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "command", "default", 2, "source /pulsar/conf/envfile")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "image", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "image", "enum", 0, "alpine")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "name", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "name", "enum", 0, "init-config")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "type", "array")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "required", 0, "mountPath")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "required", 1, "name")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "properties", "mountPath", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "properties", "mountPath", "enum", 0, "/pulsar/conf")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "properties", "name", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "items", 0, "properties", "name", "enum", 0, "config-volume")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "default", 0, "mountPath", "/pulsar/conf")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "items", 0, "properties", "volumeMounts", "default", 0, "name", "config-volume")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "default", 0, "command", 0, "/bin/sh")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "default", 0, "command", 1, "-c")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "default", 0, "command", 2, "source /pulsar/conf/envfile")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "default", 0, "image", "alpine")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "default", 0, "name", "init-config")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "default", 0, "volumeMounts", 0, "mountPath", "/pulsar/conf")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "initContainers", "default", 0, "volumeMounts", 0, "name", "config-volume")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "volumes", "type", "array")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "volumes", "items", 0, "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "volumes", "items", 0, "required", 0, "configMap")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "volumes", "items", 0, "required", 1, "name")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "volumes", "items", 0, "properties", "configMap", "type", "object")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "volumes", "items", 0, "properties", "configMap", "required", 0, "name")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "volumes", "items", 0, "properties", "configMap", "properties", "name", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "volumes", "items", 0, "properties", "configMap", "properties", "name", "enum", 0, "pulsar-admin-config")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "volumes", "items", 0, "properties", "name", "type", "string")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "volumes", "items", 0, "properties", "name", "enum", 0, "config-volume")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "volumes", "default", 0, "configMap", "name", "pulsar-admin-config")).').
#bias('user(eg(id0), input("properties", "spec", "properties", "volumes", "default", 0, "name", "config-volume")).').
